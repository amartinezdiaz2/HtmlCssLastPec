...
const finDeViaje = {
    ...
    categoria: "Novela",
    figure: new URL("../img/books/FinDeViaje.jpg", import.meta.url),
    figureWebp: new URL("../img/books/FinDeViaje.webp", import.meta.url),
    figureS: new URL("../img/books/small/FinDeViaje-small.jpg", import.meta.url),
    figureWebpS: new URL("../img/books/small/FinDeViaje-small.webp", import.meta.url),
    figureSt: new URL("../img/books/smallest/FinDeViaje-smallest.jpg", import.meta.url),
    figureWebpSt: new URL("../img/books/smallest/FinDeViaje-smallest.webp", import.meta.url)
}
...
const nocheDia = {
    ...
    categoria: "Novela",
    figure: new URL("../img/books/NocheYDia.jpg", import.meta.url),
    figureWebp: new URL("../img/books/NocheYDia.webp", import.meta.url),
    figureS: new URL("../img/books/small/NocheYDia-small.jpg", import.meta.url),
    figureWebpS: new URL("../img/books/small/NocheYDia-small.webp", import.meta.url),
    figureSt: new URL("../img/books/smallest/NocheYDia-smallest.jpg", import.meta.url),
    figureWebpSt: new URL("../img/books/smallest/NocheYDia-smallest.webp", import.meta.url)
}
...
const jardinesKew = {
    ...
    categoria: "Cuento",
    figure: new URL("../img/books/KewGardens.jpg", import.meta.url),
    figureWebp: new URL("../img/books/KewGardens.webp", import.meta.url),
    figureS: new URL("../img/books/small/KewGardens-small.jpg", import.meta.url),
    figureWebpS: new URL("../img/books/small/KewGardens-small.webp", import.meta.url),
    figureSt: new URL("../img/books/smallest/KewGardens-smallest.jpg", import.meta.url),
    figureWebpSt: new URL("../img/books/smallest/KewGardens-smallest.webp", import.meta.url)
}
...
const lunesMartes = {
    ...
    categoria: "Cuento",
    figure: new URL("../img/books/LunesOMartes.jpg", import.meta.url),
    figureWebp: new URL("../img/books/LunesOMartes.webp", import.meta.url),
    figureS: new URL("../img/books/small/LunesOMartes-small.jpg", import.meta.url),
    figureWebpS: new URL("../img/books/small/LunesOMartes-small.webp", import.meta.url),
    figureSt: new URL("../img/books/smallest/LunesOMartes-smallest.jpg", import.meta.url),
    figureWebpSt: new URL("../img/books/smallest/LunesOMartes-smallest.webp", import.meta.url)
}
...
const cuartoJacob = {
    ...
    categoria: "Novela",
    figure: new URL("../img/books/ElCuartoDeJacob.jpg", import.meta.url),
    figureWebp: new URL("../img/books/ElCuartoDeJacob.webp", import.meta.url),
    figureS: new URL("../img/books/small/ElCuartoDeJacob-small.jpg", import.meta.url),
    figureWebpS: new URL("../img/books/small/ElCuartoDeJacob-small.webp", import.meta.url),
    figureSt: new URL("../img/books/smallest/ElCuartoDeJacob-smallest.jpg", import.meta.url),
    figureWebpSt: new URL("../img/books/smallest/ElCuartoDeJacob-smallest.webp", import.meta.url)
}
...
const señoraDalloway = {
    ...
    categoria: "Novela",
    figure: new URL("../img/books/LaSeñoraDalloway.jpg", import.meta.url),
    figureWebp: new URL("../img/books/LaSeñoraDalloway.webp", import.meta.url),
    figureS: new URL("../img/books/small/LaSeñoraDalloway-small.jpg", import.meta.url),
    figureWebpS: new URL("../img/books/small/LaSeñoraDalloway-small.webp", import.meta.url),
    figureSt: new URL("../img/books/smallest/LaSeñoraDalloway-smallest.jpg", import.meta.url),
    figureWebpSt: new URL("../img/books/smallest/LaSeñoraDalloway-smallest.webp", import.meta.url)
}
...
const lectorComun = {
    ...
    categoria: "Ensayo",
    figure: new URL("../img/books/ElLectorComun.jpg", import.meta.url),
    figureWebp: new URL("../img/books/ElLectorComun.webp", import.meta.url),
    figureS: new URL("../img/books/small/ElLectorComun-small.jpg", import.meta.url),
    figureWebpS: new URL("../img/books/small/ElLectorComun-small.webp", import.meta.url),
    figureSt: new URL("../img/books/smallest/ElLectorComun-smallest.jpg", import.meta.url),
    figureWebpSt: new URL("../img/books/smallest/ElLectorComun-smallest.webp", import.meta.url)
}
...
const alFaro = {
    ...
    categoria: "Novela",
    figure: new URL("../img/books/AlFaro.jpg", import.meta.url),
    figureWebp: new URL("../img/books/AlFaro.webp", import.meta.url),
    figureS: new URL("../img/books/small/AlFaro-small.jpg", import.meta.url),
    figureWebpS: new URL("../img/books/small/AlFaro-small.webp", import.meta.url),
    figureSt: new URL("../img/books/smallest/AlFaro-smallest.jpg", import.meta.url),
    figureWebpSt: new URL("../img/books/smallest/AlFaro-smallest.webp", import.meta.url)
}
...
const orlando = {
    ...
    categoria: "Biografía",
    figure: new URL("../img/books/Orlando.jpg", import.meta.url),
    figureWebp: new URL("../img/books/Orlando.webp", import.meta.url),
    figureS: new URL("../img/books/small/Orlando-small.jpg", import.meta.url),
    figureWebpS: new URL("../img/books/small/Orlando-small.webp", import.meta.url),
    figureSt: new URL("../img/books/smallest/Orlando-smallest.jpg", import.meta.url),
    figureWebpSt: new URL("../img/books/smallest/Orlando-smallest.webp", import.meta.url)
}
...
const habitacionPropia = {
    ...
    categoria: "Ensayo",
    figure: new URL("../img/books/UnaHabitacionPropia.jpg", import.meta.url),
    figureWebp: new URL("../img/books/UnaHabitacionPropia.webp", import.meta.url),
    figureS: new URL("../img/books/small/UnaHabitacionPropia-small.jpg", import.meta.url),
    figureWebpS: new URL("../img/books/small/UnaHabitacionPropia-small.webp", import.meta.url),
    figureSt: new URL("../img/books/smallest/UnaHabitacionPropia-smallest.jpg", import.meta.url),
    figureWebpSt: new URL("../img/books/smallest/UnaHabitacionPropia-smallest.webp", import.meta.url)
}
...
const deLaEnfermedad = {
    ...
    categoria: "Ensayo",
    figure: new URL("../img/books/DeLaEnfermedad.jpg", import.meta.url),
    figureWebp: new URL("../img/books/DeLaEnfermedad.webp", import.meta.url),
    figureS: new URL("../img/books/small/DeLaEnfermedad-small.jpg", import.meta.url),
    figureWebpS: new URL("../img/books/small/DeLaEnfermedad-small.webp", import.meta.url),
    figureSt: new URL("../img/books/smallest/DeLaEnfermedad-smallest.jpg", import.meta.url),
    figureWebpSt: new URL("../img/books/smallest/DeLaEnfermedad-smallest.webp", import.meta.url)
}
...
const lasOlas = {
    ...
    categoria: "Novela",
    figure: new URL("../img/books/LasOlas.jpg", import.meta.url),
    figureWebp: new URL("../img/books/LasOlas.webp", import.meta.url),
    figureS: new URL("../img/books/small/LasOlas-small.jpg", import.meta.url),
    figureWebpS: new URL("../img/books/small/LasOlas-small.webp", import.meta.url),
    figureSt: new URL("../img/books/smallest/LasOlas-smallest.jpg", import.meta.url),
    figureWebpSt: new URL("../img/books/smallest/LasOlas-smallest.webp", import.meta.url)
}
...
const paseosLondres = {
    ...
    categoria: "Ensayo",
    figure: new URL("../img/books/PaseosPorLondres.jpg", import.meta.url),
    figureWebp: new URL("../img/books/PaseosPorLondres.webp", import.meta.url),
    figureS: new URL("../img/books/small/PaseosPorLondres-small.jpg", import.meta.url),
    figureWebpS: new URL("../img/books/small/PaseosPorLondres-small.webp", import.meta.url),
    figureSt: new URL("../img/books/smallest/PaseosPorLondres-smallest.jpg", import.meta.url),
    figureWebpSt: new URL("../img/books/smallest/PaseosPorLondres-smallest.webp", import.meta.url)
}
...
const Flush = {
    ...
    categoria: "Biografía",
    figure: new URL("../img/books/Flush.jpg", import.meta.url),
    figureWebp: new URL("../img/books/Flush.webp", import.meta.url),
    figureS: new URL("../img/books/small/Flush-small.jpg", import.meta.url),
    figureWebpS: new URL("../img/books/small/Flush-small.webp", import.meta.url),
    figureSt: new URL("../img/books/smallest/Flush-smallest.jpg", import.meta.url),
    figureWebpSt: new URL("../img/books/smallest/Flush-smallest.webp", import.meta.url)
}
...
const losAños = {
    ...
    categoria: "Novela",
    figure: new URL("../img/books/LosAños.jpg", import.meta.url),
    figureWebp: new URL("../img/books/LosAños.webp", import.meta.url),
    figureS: new URL("../img/books/small/LosAños-small.jpg", import.meta.url),
    figureWebpS: new URL("../img/books/small/LosAños-small.webp", import.meta.url),
    figureSt: new URL("../img/books/smallest/LosAños-smallest.jpg", import.meta.url),
    figureWebpSt: new URL("../img/books/smallest/LosAños-smallest.webp", import.meta.url)
}
...
const tresGuineas = {
    ...
    categoria: "Ensayo",
    figure: new URL("../img/books/TresGuineas.jpg", import.meta.url),
    figureWebp: new URL("../img/books/TresGuineas.webp", import.meta.url),
    figureS: new URL("../img/books/small/TresGuineas-small.jpg", import.meta.url),
    figureWebpS: new URL("../img/books/small/TresGuineas-small.webp", import.meta.url),
    figureSt: new URL("../img/books/smallest/TresGuineas-smallest.jpg", import.meta.url),
    figureWebpSt: new URL("../img/books/smallest/TresGuineas-smallest.webp", import.meta.url)
}
...
const rogerFry = {
    ...
    categoria: "Biografía",
    figure: new URL("../img/books/RogerFry.jpg", import.meta.url),
    figureWebp: new URL("../img/books/RogerFry.webp", import.meta.url),
    figureS: new URL("../img/books/small/RogerFry-small.jpg", import.meta.url),
    figureWebpS: new URL("../img/books/small/RogerFry-small.webp", import.meta.url),
    figureSt: new URL("../img/books/smallest/RogerFry-smallest.jpg", import.meta.url),
    figureWebpSt: new URL("../img/books/smallest/RogerFry-smallest.webp", import.meta.url)
}
...
const entreActos = {
    ...
    categoria: "Novela",
    figure: new URL("../img/books/EntreActos.jpg", import.meta.url),
    figureWebp: new URL("../img/books/EntreActos.webp", import.meta.url),
    figureS: new URL("../img/books/small/EntreActos-small.jpg", import.meta.url),
    figureWebpS: new URL("../img/books/small/EntreActos-small.webp", import.meta.url),
    figureSt: new URL("../img/books/smallest/EntreActos-smallest.jpg", import.meta.url),
    figureWebpSt: new URL("../img/books/smallest/EntreActos-smallest.webp", import.meta.url)
}
...
if(window.location.href.includes("libros")){
    for (let i = 0; i < 18; i ++) {
        ...
        let figure = document.createElement("picture");
        let source1 = document.createElement("source");
        source1.type = "image/webp";
        source1.srcset = libros[i].figureWebpS.toString() + ' 200w, ' + libros[i].figureWebpSt.toString() + '  150w';
        source1.className = "lazyload";
        figure.appendChild(source1);
        let source2 = document.createElement("source");
        source2.type = "image/jpeg";
        source2.srcset = libros[i].figureS.toString() + ' 200w, ' + libros[i].figureSt.toString() + ' 150w';
        source2.className = "lazyload";
        figure.appendChild(source2);
        let img = document.createElement("img");
        img.src = libros[i].figureS.toString();
        img.srcset = libros[i].figureS.toString() + ' 200w, ' + libros[i].figureSt.toString() + ' 150w';
        img.sizes = '100vw';
        img.width = 200;
        img.height = 300;
        img.loading = "lazy";
...
if(window.location.href.includes("librodetalle")){
    ...
    // @ts-ignore
    informacion.firstElementChild.firstElementChild.srcset = libro.figureWebp.href + ' 300w, ' + libro.figureWebpS.href + ' 200w';
    // @ts-ignore
    informacion.firstElementChild.children[1].srcset = libro.figure.href + ' 300w, ' + libro.figureS.href + ' 200w';
    // @ts-ignore
    ...
    for(let j = 0; j < listado.length; j ++){
        ...
        if(otroLibro.id !== libro.id){
            ...
            let oFigure = document.createElement("picture");
            let source1 = document.createElement("source");
            source1.type = "image/webp";
            source1.srcset = otroLibro.figureWebpS.href + ' 200w, ' + otroLibro.figureWebpSt.href + '  150w';
            source1.className = "lazyload";
            ...
            oImg.srcset = otroLibro.figureS.href + ' 200w, ' + otroLibro.figureSt.href + ' 150w';
            oImg.sizes = '100vw';
            oImg.width = 150;
            oImg.height = 250;
            oImg.loading = "lazy";
            oImg.className = "lazyload";
